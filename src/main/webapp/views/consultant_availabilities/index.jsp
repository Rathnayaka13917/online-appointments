...
<div class="card mx-5 my-5">
    <div class="card-header border-0 pt-6 my-1">
        <div class="card-title">
            <h5>Consultants Availabilities</h5>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
                <a href="/online-appointments/views/consultant_availabilities/_form.jsp"><button type="button" class="btn btn-primary">Add New Availability</button></a>
            </div>
        </div>
    </div>
    <div class="card-body">
